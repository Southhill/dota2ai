...
Consider[1] = function()
	...
	--+ability:GetSpecialValueFloat( "delay" );
...
Consider[6] = function()
	...
	if
	 ...
	 then
		...
		if (npcTarget ~= nil) then
			if (GetUnitToUnitDistance(npcBot, npcTarget) < CastRange + 75 * #allys) then
...
local function IsSnowballTarget(t)
	return t:HasModifier("modifier_tusk_snowball_target")
end
