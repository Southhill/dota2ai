...
Consider[1] = function()
	...
	if (CanCast[abilityNumber](StrongstCreep)) then
...
Consider[2] = function()
	...
	--protect myself
	if
		(npcBot:WasRecentlyDamagedByAnyHero(2) or
			(npcBot:GetActiveMode() == BOT_MODE_RETREAT and HealthPercentage <= 0.4 + #enemys * 0.05))
	 then
